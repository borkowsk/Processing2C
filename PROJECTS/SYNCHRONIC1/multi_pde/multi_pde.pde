...
singiel First, Second; //!< Te nazwy to tylko uchwyty do obiektów, coś jak zwykła liczba `float` czy `integer`,
...
void setup()
{
 ...
 println("1st:",First.x1+
         " "+First.r+
         " alfa:"+First.sync); // uchwyt do obiektu, robi za nazwę obiektu, kropka i nazwa pola wiec czytamy z pola (lub można też z funkcją)
...
// multi_pde.pde
String PROJECT_NAME="SYNCHRONIC1";
