...
void writeStatusLine() ///Ta nazwa musi być znana globalnie
{
  ...
  fill(128);noStroke();
  textAlign(RIGHT, TOP);
  text(String("Żyją:")+liveCount+String(" Zachorowali:")+sumInfected+String(" Wyzdrowieli:")+sumRecovered+String(" Umarli:")+sumDeath+ String("     "),width,side*cwidth);//Miejce dla NAJWAŻNIEJSZYCH STATYSTYK
