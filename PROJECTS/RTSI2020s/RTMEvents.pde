...
void keyPressed() 
{
  ...
  case '+': linkWeightTresh+=0.10;if(linkWeightTresh>0.9) linkWeightTresh=0.9;
            println("Link treshhold=",linkWeightTresh);
  ...
  case '1': STEPSperVIS=1;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '2': STEPSperVIS=2;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '3': STEPSperVIS=5;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '4': STEPSperVIS=10;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '5': STEPSperVIS=25;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '6': STEPSperVIS=50;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '7': STEPSperVIS=100;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '8': STEPSperVIS=150;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  case '9': STEPSperVIS=200;println(STEPSperVIS,"step/frame");text("StPerV: "+STEPSperVIS,0,height-16);break;
  ...
  //           break;
  //case 'N':  linkWeightTresh=0;println("Link treshhold=",linkWeightTresh);
  //           pixelizeProperties2D(theWorld.properties);
  //           theWorld.currFilter=comboVisFilter.reset(WhichProperty,linkWeightTresh);
  //           break;
  ...
  //           println("Visualise property #"+WhichProperty);
  //           pixelizeProperties2D(theWorld.properties);
  //           theWorld.currFilter=comboVisFilter.reset(WhichProperty,linkWeightTresh);
  //           break;
